...
function drawUserIDScreen() {
  ...
  let instructions = createDiv(
    "Instructions: <br> 1. As palavras estão ordenadas ALFABETICAMENTE por COLUNAS! \
  ...
  instructions.position(
    10,
    display_size_pos_y_offset + display_size_form.size().height + 20
  );
}
...
function validSize() {
  if (
    ...
    parseInt(display_size_form.value()) > 12
  )
    return true;
  else {
